    ...
    public function run()
    {
        $products = [
            ...
            [
                ...
                'image' => 'landing/products/10.webp',
                'is_active' => true,
                'is_featured' => false,
            ],
            [
                ...
                'image' => 'landing/products/11.webp',
                'is_active' => true,
                'is_featured' => true,
            ],
            [
                ...
                'image' => 'landing/products/12.webp',
                'is_active' => true,
                'is_featured' => true,
            ],
            [
                ...
                'image' => 'landing/products/13.webp',
                'is_active' => true,
                'is_featured' => false,
            ],
            [
                ...
                'price' => 50.00,
                'description' => 'Du möchtest jemanden einen persönlichen Gutschein schenken, bei dem du jemandem auch noch etwas Gutes tust.',
                'image' => 'landing/products/14.webp',
                'is_active' => true,
                'is_featured' => false,
            ],
            [
                ...
                'price' => 120.00,
                'description' => 'Du möchtest jemanden einen persönlichen Gutschein schenken, bei dem du jemandem auch noch etwas Gutes tust.',
                'image' => 'landing/products/15.webp',
                'is_active' => true,
                'is_featured' => false,
            ],
        ];
