                ...
                <div class="d-flex flex-column pt-lg-20">
                    ...
                    <div class="row g-10">
                        ...
                        <div class="col-xl-6 col-md-6" data-aos="fade-up" data-aos-easing="linear"
                            ...
                            <div class="card card-shadow shadow card-borderless mb-5 h-100 bg-white">
                                <div class="card-body p-0w-100 h-400px object-fit-cover rounded"
                                        style="background-repeat: no-repeat;background-size: cover;background-position:center;background-image: url('{{ asset(theme()->getMediaUrlPath() . 'landing/transformationsraum/office-1.webp') }}')">
                                </div>
                            </div>
                        </div>
                        <!--end::Image 1-->
                        ...
                        <div class="col-xl-6 col-md-6" data-aos="fade-up" data-aos-easing="linear"
                            ...
                            <div class="card card-shadow shadow card-borderless mb-5 h-100 bg-white">
                                <div class="card-body p-0w-100 h-400px object-fit-cover rounded"
                                        style="background-repeat: no-repeat;background-size: cover;background-position:center;background-image: url('{{ asset(theme()->getMediaUrlPath() . 'landing/transformationsraum/office-2.webp') }}')">
                                </div>
                            </div>
                        </div>
                        <!--end::Image 2-->
                        ...
                        <div class="col-xl-6 col-md-6" data-aos="fade-up" data-aos-easing="linear"
                            ...
                            <div class="card card-shadow shadow card-borderless mb-5 h-100 bg-white">
                                <div class="card-body p-0w-100 h-400px object-fit-cover rounded"
                                        style="background-repeat: no-repeat;background-size: cover;background-position:center;background-image: url('{{ asset(theme()->getMediaUrlPath() . 'landing/transformationsraum/office-3.webp') }}')">
                                </div>
                            </div>
                        </div>
                        <!--end::Image 3-->
