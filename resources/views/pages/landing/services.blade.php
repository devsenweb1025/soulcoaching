                            ...
                            <div class="w-100 h-100 py-lg-10 py-md-5 d-flex flex-column justify-content-center align-items-center"
                                ...
                                @php
                                    $image = \App\Models\PageContent::where('page', 'images')
                                        ...
                                        ->first();
                                    $imageUrl = $image
                                        ? json_decode($image->content, true)['url']
                                        : asset(
                                            theme()->getMediaUrlPath() .
                                                'landing/elisabeth-kartenlegerin-telefonberatung-seelenfluesterin.webp',
                                        );
                                @endphp
                                <img src="{{ $imageUrl }}"
                                ...
                                @php
                                    ...
                                    $imageUrl = $image
                                        ...
                                        : asset(
                                            theme()->getMediaUrlPath() .
                                                'landing/beraterprofil-platzhalter-hotline-seelenfluesterin.webp',
                                        );
                                @endphp
                                <img src="{{ $imageUrl }}"
