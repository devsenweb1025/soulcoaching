                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="badge badge-light-success fs-base">
                                ...
                                <!--end::Svg Icon-->
                                {{ number_format(($salesData->last() - $salesData->first()) / $salesData->first() * 100, 1) }}%
                            </span>
                            <!--end::Badge-->
                        </div>
                        <!--end::Info-->
                ...
                <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                    ...
                    <div class="d-flex flex-column content-justify-center flex-row-fluid">
                        ...
                        <div class="d-flex fw-semibold align-items-center">
                            ...
                            <!--end::Label-->
                            <!--begin::Stats-->
                            <div class="fw-bolder text-gray-700 text-xxl-end">CHF {{ number_format($salesData->where('type', 'course')->sum('amount'), 0, ',', '.') }}</div>
                            <!--end::Stats-->
                        </div>
                        <!--end::Label-->
                        <!--begin::Label-->
                        <div class="d-flex fw-semibold align-items-center my-3">
                            ...
                            <!--end::Label-->
                            <!--begin::Stats-->
                            <div class="fw-bolder text-gray-700 text-xxl-end">CHF {{ number_format($salesData->where('type', 'product')->sum('amount'), 0, ',', '.') }}</div>
                            <!--end::Stats-->
                        </div>
                        <!--end::Label-->
                        <!--begin::Label-->
                        <div class="d-flex fw-semibold align-items-center">
                            ...
                            <!--end::Label-->
                            <!--begin::Stats-->
                            <div class="fw-bolder text-gray-700 text-xxl-end">CHF {{ number_format($salesData->where('type', 'other')->sum('amount'), 0, ',', '.') }}</div>
                            <!--end::Stats-->
                        </div>
                        <!--end::Label-->
                    </div>
